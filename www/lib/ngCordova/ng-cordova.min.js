        ...
        return{adfs: function (t, r, o) {
            ...
            if (window.cordova) {
                ...
                if (a.hasOwnProperty("org.apache.cordova.inappbrowser") === !0)if ("undefined" != typeof jsSHA) {
                    ...
                    n({method: "post", url: "https://api.twitter.com/oauth/request_token", headers: {Authorization: u.authorization_header, "Content-Type": "application/x-www-form-urlencoded"}, data: "oauth_callback=" + encodeURIComponent("http://localhost/callback")}).success(function (e) {
                        ...
                        s.addEventListener("loadstart", function (e) {
                            if (0 === e.url.indexOf("http://localhost/callback")) {
                                ...
                                n({method: "post", url: "https://api.twitter.com/oauth/access_token", headers: {Authorization: f.authorization_header}, params: {oauth_verifier: u.oauth_verifier}}).success(function (e) {
                ...
                if (o.hasOwnProperty("org.apache.cordova.inappbrowser") === !0) {
                    ...
                    i.addEventListener("loadstart", function (e) {
                        ...
                        if ("https://oauth.vk.com/blank.html" == n[0] || "http://oauth.vk.com/blank.html" == n[0]) {
                            ...
                            void 0 !== a.access_token && null !== a.access_token ? r.resolve({access_token: a.access_token, expires_in: a.expires_in, user_id: a.user_id}) : r.reject("Problem authenticating"), setTimeout(function () {
                                i.close()
                            }, 10)
                        }
                    }), i.addEventListener("exit", function () {
                ...
                if (r.hasOwnProperty("org.apache.cordova.inappbrowser") === !0) {
                    ...
                    o.addEventListener("loadstart", function (e) {
                        if (0 === e.url.indexOf("http://localhost/callback")) {
                            ...
                            for (var n = e.url.split("#")[1], r = n.split("&"), i = [], a = 0; a < r.length; a++)i[r[a].split("=")[0]] = r[a].split("=")[1];
                            void 0 !== i.access_token && null !== i.access_token ? t.resolve({access_token: i.access_token, expires_in: i.expires_in, account_username: i.account_username}) : t.reject("Problem authenticating")
                        }
                    }), o.addEventListener("exit", function () {
                        t.reject("The sign in flow was canceled")
                    })
