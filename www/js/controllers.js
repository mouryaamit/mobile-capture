...
controllers
    .controller(
    'CaptureCtrl',
    function ($scope, appFactory, gConfig, ServerConfig, $cordovaCamera,$soap) {// 31191
...
//						  this.updateCheckProgress();
        ...
        $scope.init = function () {
            ...
            appFactory.getLocations($scope.locations,gConfig.MerchantID,'edesk50',gConfig.ApplicationType).then(function (getLocationsResult) {
